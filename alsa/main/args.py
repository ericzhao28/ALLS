...
from alsa.nets.cifar import CIFARNet, SimpleCIFARNet
...
def get_args(argstring):
    ...
    parser.add_argument('--shift_strategy', type=str,
...
def get_net_cls(args):
    ...
    if args.dataset == "cifar":
        return SimpleCIFARNet if args.simple_model else CIFARNet
